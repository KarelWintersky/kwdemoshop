...
$ref_name = IsSet($_GET["name"]) ? ($_GET["name"]) : "ref_test";
$ref_prompt = IsSet($_GET["prompt"]) ? ($_GET["prompt"]) : $ref_name;
$link = ConnectDB();

$query = "SELECT id,data FROM $ref_name ORDER BY id";
...
<head>
    ...
    <script>
        ...
        function confirm_purge(id,targ) {
            ...
            {
                req = 'ref/ref_action_purge.php?id='+id+'&name=<?php echo $ref_name ?>';
...
<div id="content">
    ...
    <table border="1" width="40%">
        <tr><td>Справочник</td></td><td colspan="5"><?php echo $ref_prompt;?></td></tr>
        <tr><td>Записей:</td><td colspan="5"><?php echo $numrows;?></td></tr>
        <tr><td colspan="5"><hr width="80%"></td></tr>
        <tr>
        ...
        if ($numrows)
            foreach ($ref_data as $i=>$v) {
                ...
                <tr>
                    ...
                    <td id="e_<?php echo $i; ?>"><a href="javascript://" onClick="window.open('ref/ref_edit.php?id=<?php echo $i; ?>&ref=<?php echo $ref_name?>','Редактирование элемента справочника <?php echo $ref_name?>','scrollbars=1,width=830,height=200,top=160,left=60')"><img src="ref/edit.png" border="0"></a></td>
                    <td id="d_<?php echo $i; ?>"><a href="javascript://" onClick="return confirm_purge(<?php echo $i ?>,'id_<?php echo $i; ?>')"><img src="ref/stop.png" border="0"></a></td>
                    <td id="a_<?php echo $i; ?>"><a href="javascript://" onClick="window.open('ref/ref_extdata.php?id=<?php echo $i; ?>&ref=<?php echo $ref_name?>','Расширенная информация <?php echo $ref_name?>','scrollbars=1,width=830,height=450,top=160,left=60')"><img src="ref/advanced.png" border="0"></a>    </td>
                </tr>
                <?php
            } else echo '<tr><td colspan="5">Справочник пуст!</td></tr>';
        ?>
        <tr>
            <td>
                <a href="javascript://" onClick="window.open('ref/ref_add.php?ref=<?php echo $ref_name?>','Добавление в справочник: <?php echo $ref_name?>','scrollbars=1,width=830,height=200,top=160,left=60')"><img src="ref/add.png" border="0"></a>
            </td>
            <td colspan="4">
                <a href="javascript://" onClick="window.open('ref/ref_add.php?ref=<?php echo $ref_name?>','Добавление в справочник: <?php echo $ref_name?>','scrollbars=1,width=830,height=200,top=160,left=60')">Добавление элемента</a>
            </td>
        </tr>
    </table>
    <br>
  ...
  <span id="results">
    <input  type="button" id="quest_button" value="Добавить данные"  onClick="ajaxFunction(this.form,'ref/ref_action_insert.php');return false;" tabindex="2" />
  </span>
                <br>Внимание! Дробную часть отделяйте от целой части числа ЗАПЯТОЙ "<b>,</b>"
            </div>
        </div>
    </form>
    <input type="button" value="Обновить страницу" onClick="window.location.href=window.location.href">
</div>
</body>
</html>
