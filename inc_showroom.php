...
<div style="width:260px;float:right;margin-top:10px" id="SR_list">
    <li class="showroom_a">Выберите район города:
        ...
        ?>
    <li>&nbsp;</li><li style="font-weight: 600; text-decoration: underline;" id="select_district" class="showroom_a"><a class="hover_ul" href="javascript://" onClick="return ShowAllByRel();CenterMapEmpty(59.9694553,30.2613394,'-',9)">Полный список салонов</a>
</div>
                        ...
                        foreach ($district_cont as $room_id=>$room_info)
                        {
                            if (($room_id!='title')&&($room_id!='coords')&&($room_id!='display_in_list'))
                            {
                                ...
                                <tr>
                                    ...
                                    <td width="71%" class="l" style="color: #000000">
                                    ...
                                    <td width="15%" class="c"><a href="./core/article_show.php?id=<?php echo $room_id;?>" onClick="return hs.htmlExpand(this, { width: 500, height:600, objectType: 'ajax', wrapperClassName: 'draggable-header' })"><?php echo $room_info['phone'];?></a></td>
                                    <td width="14%" class="l" id="on_map"><a class="lref" onClick="scroll(0,0);CenterMap(<?php echo $room_info['latitude'];?>,<?php echo $room_info['longitude'];?>,'<?php echo $room_info['title'];?>',<?php echo $room_info['accuracy'];?>)">На Карте</a></td>
                                </tr>
                                <?php
                            }
                        }
